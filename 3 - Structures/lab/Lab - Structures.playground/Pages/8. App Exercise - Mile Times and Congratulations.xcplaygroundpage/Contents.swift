...
var test = RunningWorkout(distance: 50, time: 10, elevation: 78)
print(test.averageMileTime)
/*:
...
var steps: Int{
    willSet {
        if steps == goal{
            print("Good job! You have reached your goal!")
    }
}
    }
...
var test1 = Steps(goal: 9000, steps: 9000)
test1.takeStep()
