...
let favoriteBook = Book(author: "Joe Smoe", title: "Hi", price: 12.2, pages: 5)
print("The title is \(favoriteBook.title), author: \(favoriteBook.author) price: \(favoriteBook.price) pages: \(favoriteBook.pages)")
/*:
