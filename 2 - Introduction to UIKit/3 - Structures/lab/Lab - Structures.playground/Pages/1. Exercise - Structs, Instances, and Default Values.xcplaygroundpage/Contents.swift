...
favouriteBook.title = "ACOMAF"
favouriteBook.author = "Sarah J. Maas"
favouriteBook.pages = 600
favouriteBook.price = 10.00
print(favouriteBook.title + " by " + favouriteBook.author + "with \(favouriteBook.pages) pages, costs \(favouriteBook.price) dollars")
