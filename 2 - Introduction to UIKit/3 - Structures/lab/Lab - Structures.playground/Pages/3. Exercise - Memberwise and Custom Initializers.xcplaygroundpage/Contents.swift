 ...
 */
let somePlace = GPS.init(longitude: 51.514004, latitude: 0.125226)
...
var favouriteBook = Book.init(author: "SJM", title: "ACOMAF", pages: 600, price: 10.0)
print(favouriteBook)
/*:
 ...
 */
var someonesHeight = Height.init(Inches: 65)
print(someonesHeight.Centi)
/*:
 ...
 */
var myHeight = Height.init(Centi: 175)
print(myHeight)
