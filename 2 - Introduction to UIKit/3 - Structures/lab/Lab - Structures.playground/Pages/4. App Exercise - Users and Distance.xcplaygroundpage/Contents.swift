 ...
 */
var Brigitte = User.init(name: "Brigitte", age: 14, height: 175.0, weight: 180.0, activityLevel: 6)
print(Brigitte)
/*:
 ...
 */
var mile = Distance.init(meters: 1600.0)
print(mile.feet)
/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
var someDistance = Distance.init(meters: 800.0)
print(someDistance)
